...
-- ---------------------------------------------------------------------------
-- 5) World calendar (ANB); event_on uses Gregorian year 2000 as storage anchor
-- ---------------------------------------------------------------------------
...
comment on table public.calendar_events is 'Campaign calendar entries; UI shows month/day in ANB year; event_on uses year 2000 only.';
...
-- ---------------------------------------------------------------------------
-- 6) Campaign “current day” (singleton) — highlighted on calendar; admins update
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 7) Mission board (shared missions; UI uses rank for scroll colors)
-- ---------------------------------------------------------------------------
